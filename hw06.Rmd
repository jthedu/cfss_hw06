...
income_mean %>%
  ...
  labs(title = "Mean Income of Each Income Group Across Race",
       x = "", y = "Mean income (normalized 2019 dollars)",
...
income_mean %>%
  ...
  labs(title = "Mean Income by Race Over Time",
       x = "Year", y = "Mean income (in normalized 2019 dollars)",
...
meaninc_compare %>%
  ...
  knitr::kable(
    caption = "Averages of family wealth indicators (2019 dollars)", 
    col.names = c(
      "Race",
      "Mean income", 
      "Loan debt", 
...
compare_inc(retirement, retirement) +
  labs(title = "Mean Family Income vs. Mean Retirement Savings", 
       subtitle = "(normalized 2019 dollars)",
...
compare_inc(student_debt, loan_debt) +
  labs(title = "Mean Family Income vs. Mean Family Student Loan Debt", 
       subtitle = "(normalized 2019 dollars)",
